...
GPSTransform::EllToXYZ(const std::vector<Eigen::Vector3d> &ell) const {
...
std::vector<Eigen::Vector3d>
GPSTransform::XYZToEll(const std::vector<Eigen::Vector3d> &xyz) const {
...
std::vector<Eigen::Vector3d>
GPSTransform::EllToENU(const std::vector<Eigen::Vector3d> &ell,
...
std::vector<Eigen::Vector3d>
GPSTransform::XYZToENU(const std::vector<Eigen::Vector3d> &xyz,
                       const double lat0, const double lon0) const {
...
std::vector<Eigen::Vector3d>
GPSTransform::ENUToEll(const std::vector<Eigen::Vector3d> &enu,
...
std::vector<Eigen::Vector3d>
GPSTransform::ENUToXYZ(const std::vector<Eigen::Vector3d> &enu,
                       const double lat0, const double lon0,
                       const double alt0) const {
  ...
  for (std::size_t i = 0; i < enu.size(); ++i) {
